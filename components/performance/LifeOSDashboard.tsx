...
import {
  ...
  editarEventoLifeOS,
  editarTarefaLifeOS,
  registrarTarefaLifeOS,
  removerEventoLifeOS,
  removerTarefaLifeOS,
  salvarCarteiraLifeOS,
...
} from "@/components/performance/DashboardMetricWidgets";
...
import {
  AllDayEventRows,
  BAHIA_TIME_LABEL_FORMATTER,
  CurrentDayTimeline,
  dateKeyInBahia,
} from "@/components/performance/PerformanceTimeline";
import type {
  InvestmentPlan,
...
function SettingsView(props: LifeOSProps) {
  return (
    <PerfilEditor
      userId={props.userId}
      nome={props.nome}
