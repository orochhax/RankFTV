...
const BENEFICIOS_PADRAO = [
  ...
  { icon: Sparkles,      label: "Categoria balanceada — a plataforma sugere a categoria certa",             locked: false },
  ...
  { icon: Wallet,        label: "Inscrição e pagamento online — atleta paga na hora, dinheiro confirmado",  locked: false },
