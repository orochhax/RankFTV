...
- [ ] Verificar, implementar e testar o alerta automático quando a data de um campeonato for alterada. Hoje a edição registra a mudança, mas não envia esse aviso automaticamente. Cada atleta com ingresso pago e ativo deve receber no próprio e-mail uma mensagem destacada como importante, informando claramente a data anterior e a nova data. O envio deve alcançar os dois integrantes da dupla, respeitar ingressos com e-mail compartilhado sem duplicar mensagens idênticas, excluir pedidos pendentes/expirados/estornados, ter idempotência, tentativas seguras e auditoria no painel administrativo. Testar também Gmail e Outlook, alterações repetidas e falha parcial de entrega.
