...
- [ ] Definir, implementar e testar a prevenção e a recuperação de e-mail digitado incorretamente em compras sem conta. Antes do pagamento, exigir revisão explícita dos dois e-mails e decidir se o e-mail do comprador deve ser validado por OTP. Depois da compra, permitir que quem ainda possui o link gerencial corrija os e-mails; a correção deve invalidar links, QR codes e códigos antigos, gerar novas credenciais e reenviar a entrega. Se o comprador também perdeu o link e o próprio e-mail está errado, criar atendimento assistido com prova de identidade e pagamento, auditoria e rotação de todos os tokens. A recuperação pública nunca deve informar se o CPF existe nem qual dos dados está divergente.
