...
- [ ] Homologar a prevenção de e-mail digitado incorretamente no checkout sem conta: cada endereço deve ser confirmado por redigitação; o mesmo e-mail para os dois atletas só pode ser usado após confirmação explícita, ocultando os campos redundantes do atleta 2 e exibindo o aviso de acesso compartilhado; cliente e servidor devem bloquear divergências ou repetição sem consentimento. A tela de revisão deve exibir claramente nome, e-mail, categoria, forma de pagamento e total antes de criar a cobrança.
