// Calendário REAL da temporada 2026 de futevôlei (circuitos Brasil Open, TAFC,
// Circuito Brasileiro de Futevôlei e Big WolfCup). São eventos informativos — não
...
export const REAL_EVENTS: RealEvent[] = [
  // ── 1º semestre ───────────────────────────────────────────────
  { id: "ev-2026-02-xangrila",     circuito: "Big WolfCup",                          cidade: "Xangri-lá",       estado: "RS", dataInicio: "2026-02-06", dataFim: "2026-02-08" },
  { id: "ev-2026-02-joao-pessoa",  circuito: "TAFC",                              cidade: "João Pessoa",     estado: "PB", dataInicio: "2026-02-26", dataFim: "2026-03-01" },
  ...
  { id: "ev-2026-05-sorriso",      circuito: "TAFC",                              cidade: "Sorriso",         estado: "MT", dataInicio: "2026-05-14", dataFim: "2026-05-17" },
  { id: "ev-2026-05-cuiaba",       circuito: "Brasil Open",                      cidade: "Cuiabá",          estado: "MT", dataInicio: "2026-05-29", dataFim: "2026-05-31" },
  { id: "ev-2026-06-icara",        circuito: "TAFC",                              cidade: "Içara",           estado: "SC", dataInicio: "2026-06-11", dataFim: "2026-06-14" },
  { id: "ev-2026-06-bh",           circuito: "Brasil Open",                      cidade: "Belo Horizonte",  estado: "MG", dataInicio: "2026-06-18", dataFim: "2026-06-21" },
  { id: "ev-2026-07-porto-alegre", circuito: "Big WolfCup",                          cidade: "Porto Alegre",    estado: "RS", dataInicio: "2026-07-16", dataFim: "2026-07-19" },

  // ── 2º semestre ───────────────────────────────────────────────
  { id: "ev-2026-08-a",            circuito: "Brasil Open",                      cidade: "Local a definir", estado: "",   dataInicio: "2026-08-14", dataFim: "2026-08-16" },
  { id: "ev-2026-08-b",            circuito: "TAFC",                              cidade: "Local a definir", estado: "",   dataInicio: "2026-08-21", dataFim: "2026-08-23" },
  ...
  { id: "ev-2026-10-nov",          circuito: "TAFC",                              cidade: "Local a definir", estado: "",   dataInicio: "2026-10-30", dataFim: "2026-11-01" },
  { id: "ev-2026-11-a",            circuito: "Brasil Open",                      cidade: "Local a definir", estado: "",   dataInicio: "2026-11-13", dataFim: "2026-11-15" },
  { id: "ev-2026-11-b",            circuito: "Big WolfCup",                          cidade: "Local a definir", estado: "",   dataInicio: "2026-11-20", dataFim: "2026-11-22" },
  { id: "ev-2026-12-rio",          circuito: "TAFC",                              cidade: "Rio de Janeiro",  estado: "RJ", dataInicio: "2026-12-18", dataFim: "2026-12-20" },
];
