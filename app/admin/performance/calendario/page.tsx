...
export default async function CalendarPage() {
  ...
  return <PerformanceConfirmProvider><main className="life-os-theme min-h-screen bg-[#0b0d10] text-white"><CalendarClient events={events} initialDate={todayDateInBahia()} /></main></PerformanceConfirmProvider>;
}
