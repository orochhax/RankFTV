...
export default async function FinanceiroPage({
  ...
  // Inscrições com dupla + categoria
  ...
  // Batch-fetch perfis de todos os atletas
  const athleteIds = [
    ...new Set(
      regs.flatMap((r) =>
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b border-gray-100 text-left text-xs font-medium uppercase tracking-wider text-gray-400">
                          ...
                          {taxaPercent > 0 && (
                            <th className="px-4 py-3 text-right">Taxa ({taxaPercent}%)</th>
                          )}
                      ...
                      <tbody className="divide-y divide-gray-100">
                        {catSummaries.map((cat, i) => {
                          const taxa   = cat.total * (taxaPercent / 100);
                          const repasse = cat.total - taxa;
                          return (
                            <tr key={i}>
